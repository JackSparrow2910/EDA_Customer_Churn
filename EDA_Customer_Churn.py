...
# plt.savefig('Percentage of churned customers.png')
...
# ax.bar_label(ax.containers[0])
# plt.savefig('Churn_Senior_Citizen.png')
...
# plt.savefig('SeniorCitizenChurn_StackedBar.png')
